  ...
  [844],
  {
    './node_modules/@storybook/blocks/dist/Color-6VNJS4EI.mjs': (
      ...
      var R,
        ...
        PickerTooltip = (0, dist.kb)(components_dist.I9)({ position: 'absolute', zIndex: 1, top: 4, left: 4 }),
        ...
        Note = (0, dist.kb)(components_dist.Up)(({ theme }) => ({ fontFamily: theme.typography.fonts.base })),
        ...
        ColorControl = ({ name, value: initialValue, onChange, onFocus, onBlur, presetColors, startOpen = !1 }) => {
          let { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(
              initialValue,
              (0, react.useCallback)(throttle_default()(onChange, 200), [onChange])
            ),
    ...
    './node_modules/color-convert/conversions.js': (module, __unused_webpack_exports, __webpack_require__) => {
      let cssKeywords = __webpack_require__('./node_modules/color-name/index.js'),
        reverseKeywords = {}
    ...
    './node_modules/color-convert/index.js': (module, __unused_webpack_exports, __webpack_require__) => {
      let conversions = __webpack_require__('./node_modules/color-convert/conversions.js'),
