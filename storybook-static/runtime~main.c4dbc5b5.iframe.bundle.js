;(() => {
  ...
  ;(__webpack_require__.m = __webpack_modules__),
    ...
    (() => {
      ...
      __webpack_require__.O = (result, chunkIds, fn, priority) => {
        ...
        for (var notFulfilled = 1 / 0, i = 0; i < deferred.length; i++) {
          for (
            var chunkIds = deferred[i][0], fn = deferred[i][1], priority = deferred[i][2], fulfilled = !0, j = 0;
            j < chunkIds.length;
            j++
          )
    ...
    (__webpack_require__.miniCssF = (chunkId) =>
      'static/css/' +
      { 55: 'stories-Header-stories', 256: 'stories-Page-stories', 416: 'stories-Button-stories' }[chunkId] +
      '.' +
      { 55: 'd60d34aa', 256: 'a76d5758', 416: 'b8f0e908' }[chunkId] +
      '.chunk.css'),
    ...
    (() => {
      var inProgress = {},
        dataWebpackPrefix = 'react-todolist:'
      ...
      if ('undefined' != typeof document) {
        var createStylesheet = (chunkId, fullhref, oldTag, resolve, reject) => {
                ...
                (event) => {
                  if (((linkTag.onerror = linkTag.onload = null), 'load' === event.type)) resolve()
                    ...
                    var errorType = event && ('load' === event.type ? 'missing' : event.type),
                      ...
                      err = Error('Loading CSS chunk ' + chunkId + ' failed.\n(' + realHref + ')')
          ...
          findStylesheet = (href, fullhref) => {
            ...
            for (
              var existingStyleTags = document.getElementsByTagName('style'), i = 0;
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunkreact_todolist = self.webpackChunkreact_todolist || [])
