;(self.webpackChunkreact_todolist = self.webpackChunkreact_todolist || []).push([
  [256],
  {
    './src/stories/Page.stories.ts': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      let Page_stories = { title: 'Example/Page', component: Page, parameters: { layout: 'fullscreen' } },
        LoggedOut = {},
        LoggedIn = {
          play: async (_ref) => {
            ...
            await (0, dist.ct)(loginButton).toBeInTheDocument(),
              await dist.gr.click(loginButton),
              await (0, dist.ct)(loginButton).not.toBeInTheDocument()
            let logoutButton = canvas.getByRole('button', { name: /Log out/i })
            await (0, dist.ct)(logoutButton).toBeInTheDocument()
          },
        }
